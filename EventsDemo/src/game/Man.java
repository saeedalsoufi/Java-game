 ...
 * Simple character
 */
public class Man extends Walker implements StepListener{



    // This is the enemy that spawns in level 1 and stays till level 3.
    ...
    private static final BodyImage image =
            new BodyImage("data/soldier_stand.png", 3.50f);




    public Man(World world2) {
        super(world2, shape);
        addImage(image);
